...
import Jensy from '../images/jensymaldonado1@gmail.com (2).jpg'
import Elibeth from '../images/Elibeth (2 of 13) (2).jpg'
import anna from '../images/anna.jpg'
import ventura from '../images/ventura.png'
import derwick from '../images/derwick.png'
import rosa from '../images/rosa.png'
import alex from '../images/alex.png'
import jensy from '../images/jensy2.png'
import kyle from '../images/kyle.png'
import richard1 from '../images/richard.png'
import maurico from '../images/mauricio.png'
import estefany from '../images/estefany.png'
import luis from '../images/luis.png'
import evan from '../images/evan.png'
import richard2 from '../images/richard2.png'
import gloria from '../images/gloria.png'
import keivon from '../images/keivon.png'
import rafael from '../images/rafael.png'
import arelis from '../images/arelis.png'
...
I always enjoyed the idea of creating a path for those unsure of their future and LAESA-SHPE has shown for years they are also for the community. I plan on continuing LAESA-SHPE’s missions through the 5 pillars engaging not only with students on campus but with schools around the community
                ...
                <div className ='position'>
                <img src={Tim}/>                    
                <h1> External Vice President </h1>
                <h3> Timothy Galloway Jr </h3>
                    </div>
                ...
                <div className ='position'>
                <img src={Elbin}/>                    
                <h1> Internal Vice President</h1>
                <h3> Elbin Madera Jr </h3>
                    </div>
...
I look forward to bringing the familia positive energy throughout all the events and activities we have in store for all of you!  </p>
                ...
                <img src={Elizabeth}/>                    
                <h1> Secretary </h1>
                <h3> Elizabeth Palacios </h3>
                    </div>
               
               <p className='cols'> Hello, my name is Elizabeth Palacios. I am majoring in Computer Science with a minor in Psychology. I am the Secretary for LAESA 2023-2024. I joined LAESA in November 2022, hoping to find a community of engineers that can relate to me in all aspects from career ambitions to native language and foods. I am grateful to have meant LAESA as it has given me the aspiration to unlock my potential as a professional. I also want to be that aspiration to new incoming Latinx engineer students that are doubting a career in STEM. 

I interned for American Express as a Software Engineer Intern for Summer 2022 and 2023. I am also a SEEK student at CCNY, and I work at the PAL Center to support incoming SEEK Freshmen obtain a strong academic standing throughout their first year at college. 
...
As LAESA Secretary, I am excited to not only grow within LAESA, but also to help others develop as professionals within the Famila this upcoming school year! </p>
                ...
                <div className='rowsss'>
                    ...
                    <img src={Jensy}/>  
                    <h1> President</h1>
                    <h3> Jensy Maldonado </h3>
                    </div>
                       
                    <div>
                    <img src={Elibeth}/>
                    <h1> External</h1>
                    <h3> Elibeth Martinez</h3>
                    </div>
